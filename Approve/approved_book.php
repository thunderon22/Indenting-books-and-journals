...
<body>
  ...
  <button onclick="window.location.href='../home/index.html'">Home</button>
    <button onclick="window.location.href='approved_book.php'" id="user-btn">Approve Books</button>
    <button onclick="window.location.href='approved_journal.php'">Approve Journals</button>
    <button onclick="window.location.href='approved_books_list.php'">Approved Books</button>
      ...
      <div class="col">
        <div class="card mt-5">
          <div class="card-header">
            <h2 class="display-6 text-center">Approve Books</h2>
          </div>
          <div class="card-body">
            <form action="process_approved_books.php" method="post">
              <table class="table table-bordered text-center" id="bookTable">
                <tr class="bg-dark text-white heading-row">
                  ...
                  <td>
                    <select id="publisherFilter">
                      ...
                      $query = "SELECT DISTINCT publisher FROM suggested_books";
                  ...
                  <td>
                    <select id="fieldFilter">
                      ...
                      <?php
                      require_once 'config/db1.php';
                      $query = "SELECT DISTINCT field FROM suggested_books";
                ...
                <?php
                $query = "select * from suggested_books";
  ...
  <div class="text-center mt-3">
    <button id="suggestButton" class="btn btn-success" type="button" name="approved_books">Approve Selected Books</button>
    <!-- <button id="suggestButton" class="btn btn-success" type="button" name="approved_books" onclick="window.location.href='approved_books_list.php'">Approve Selected Books</button> -->
  </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      // Handle the click event of the "Approve Selected Books" button
      $("#suggestButton").on("click", function() {
        ...
        $.ajax({
          type: "POST",
          url: "process_approved_books.php",
          data: {
            approved_books: JSON.stringify(selectedBooks)
          },
          success: function(response) {
            // Handle the response from the server, e.g., display a success message
            alert(response);
            // Redirect to approved_books_list.php
            window.location.href = 'http://localhost/indent/approve/approved_books_list.php';
          },
  ...
  <script>
              ...
              if (currentPage.includes("approved_book.php")) {
