...
<body>
  ...
  <button onclick="window.location.href='../home/index.html'">Home</button>
    ...
    <button onclick="window.location.href='approved_journals_list.php'" id="user-btn">Approved Journals</button>
      ...
      <div class="col">
        <div class="card mt-5">
          <div class="card-header">
            <h2 class="display-6 text-center">Approved Journals Details</h2>
          </div>
          <div class="card-body">
            <table class="table table-bordered text-center">
              ...
              <tr>
                ...
                $query = "select * from approved_journals";
            ...
            <script>
                ...
                if (currentPage.includes("approved_journals_list.php")) {
