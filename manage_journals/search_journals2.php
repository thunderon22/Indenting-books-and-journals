...
<body>
  ...
  <div id="navigation" class="btn-group1">
    ...
    <button onclick="window.location.href='search_journals.php'" id="user-btn">Search Journals</button>
    <button onclick="window.location.href='../admin1.php'">Logout</button>
  </div>
  <br><div class="container">
    <h2><b>Search the Journals </b></h2>
    <center>
    <form method="POST" action="">
    <label for="journalNumber"><b> Journal Number : </b></label>
            <input type="text" name="search" id="search" placeholder="Enter the Journal Number" size="30" required>
   ...
   var searchInput = document.getElementById('search');
    ...
    searchInput.addEventListener('keyup', function () {
      ...
      if (searchValue.trim() !== '') {
        ...
        xhr.open('GET', 'get_journalsuggestions.php?search=' + searchValue, true);
        xhr.send();
      }
    });
    </script>
  ...
  <script>
    ...
    if (currentPage.includes("search_journals.php")) {
