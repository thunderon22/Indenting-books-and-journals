...
<header>
  ...
  <div id="navigation" class="btn-group1">
    ...
    <button onclick="window.location.href='delete_books.php'" id="user-btn">Delete Book</button>
      ...
      <div class="col">
        <div class="card mt-5">
          <div class="card-header">
            <h2 class="display-6 text-center">Delete Book Details</h2>
          </div>
          <div class="card-body">
                ...
                if ($total != 0) {
                  while ($result = mysqli_fetch_assoc($data)) {
                    echo "
                        ...
                        <td><a href='delete.php?isbnnum=$result[isbn]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>
                        </tr>
                        ";
                  }
                } else {
            ...
            <script>
             ...
             <script>
              ...
              if (currentPage.includes("delete_books.php")) {
