...
<header>
  ...
  <div id="navigation" class="btn-group1">
    ...
    <button onclick="window.location.href='index2.php'" id="user-btn">Delete User</button>
      ...
      <div class="col">
        <div class="card mt-5">
          <div class="card-header">
            <h2 class="display-6 text-center">Delete the User Details</h2>
          </div>
          <div class="card-body">
  ...
  <script>
        ...
        if (currentPage.includes("index2.php")) {
