...
<body>
  ...
  <br><div class="container">
    ...
    <form method="POST" action="">
        ...
        <input type="text" name="search" id="search" placeholder="enter your email as username" size="30" required>
   ...
   var searchInput = document.getElementById('search');
    ...
    searchInput.addEventListener('keyup', function () {
      ...
      if (searchValue.trim() !== '') {
        ...
        xhr.open('GET', 'get_user_suggestions.php?search=' + searchValue, true);
        xhr.send();
      }
    });
    </script>
