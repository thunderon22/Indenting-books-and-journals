      ...
      <div class="col">
        <div class="card mt-5">
          <div class="card-header">
            <h2 class="display-6 text-center">Suggested Books</h2>
          </div>
          <div class="card-body">
            <table class="table table-bordered text-center">
              ...
              <tr>
                ...
                ?>
          <!-- 143 line code <td><a href='delete_book.php?isbnnum=$result[isbn]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>-->
            </table>
            <script>
